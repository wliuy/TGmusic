...
const COMMIT_MSG = 'feat: Sarah MUSIC 10.2.2 (移动端状态栏动态沉浸主题色)';
const files = {};
...
<body>
    ...
    <div class="desktop-container" id="main-ui">
        <header class="header-stack">
            ...
            <p class="brand-sub">Premium Music Hub | v10.2.2</p>
        ...
        <div id="admin-box">
            <div class="admin-header">
                <div class="flex items-center gap-3 flex-shrink-0">
                    ...
                    <span class="text-[10px] font-black text-white/40 bg-white/5 px-2 py-0.5 rounded tracking-wider">v10.2.2</span>
                </div>
    ...
    <script>
        ...
        function updateBackground(isForceRandom = false) { 
            ...
            if(metaTheme) metaTheme.setAttribute('content', isMob ? theme.deep : finalBg);
            document.body.style.backgroundColor = isMob ? theme.deep : finalBg;
            
            const stage = document.getElementById('bg-stage'), overlay = document.getElementById('bg-overlay');
            const newGrad = isMob ? theme.deep : \`linear-gradient(135deg, \${theme.bg} 0%, \${theme.deep} 100%)\`;
...
try {
    ...
    try {
        ...
        console.log('\n✅ Sarah MUSIC 10.2.2 构建成功。移动端状态栏现已完美融合动态主题色。');
